...
- 정규식 모듈에 관한 설명: [링크](https://wikidocs.net/4308)

- 슬라이싱을 사용한 코드는 코드 길이도 줄어들고 내부적으로 c로 구현되어 속도가 좋다

![/assets/img/posts/pyAlgo/chapter6/_2021-03-29_19-48-41.png](/assets/img/posts/pyAlgo/chapter6/timetable.png)

- 슬라이싱은 상당히 빠르다

  ![/assets/img/posts/pyAlgo/chapter6/_2021-03-29_19-49-28.png](/assets/img/posts/pyAlgo/chapter6/slicing.png)
